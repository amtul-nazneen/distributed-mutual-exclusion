...
public class Client4 {
	...
	private void readFromServer() throws Exception {
		...
		writeToServer1.println(Config.READ + "," + "file2");
		String reply;
	...
	private void enquireToServer() throws Exception {
		...
		writeToServer2.println(Config.ENQUIRE + "," + processnum);
	...
	private void connectToOtherClients() throws Exception {
		s1 = new Socket(Config.DC_PROC1, Config.CLIENT4_PORT);
		s2 = new Socket(Config.DC_PROC2, Config.CLIENT4_PORT);
		s3 = new Socket(Config.DC_PROC3, Config.CLIENT4_PORT);
